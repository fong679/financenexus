...
// ═══════════════════════════════════════════════════════════════
const SUPABASE_URL  = 'https://sqmpedbzaodjreflnqtk.supabase.co - project url';
...
function calcSavings(){
  ...
  makeChart('chart-savings',{type:'line',data:{labels,datasets:[{label:'Portfolio Value',data:bD,borderColor:'#10B981',backgroundColor:'rgba(16,185,129,0.08)',fill:true,tension:0.4,pointRadius:2,borderWidth:2.5},{label:'Total Invested',data:cD,borderColor:'#818CF8',backgroundColor:'rgba(129,140,248,0.06)',fill:true,tension:0.4,pointRadius:2,borderWidth:2,borderDash:[5,3]}]},options:{...baseOpts,scales:{...baseOpts.scales,y:{...baseOpts.scales.y,ticks:{...baseOpts.scales.y.ticks,callback:n=>fmtK(n)}}}}});
}
